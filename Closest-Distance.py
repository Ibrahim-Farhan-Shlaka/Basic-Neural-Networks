...
plt.legend()
plt.grid()
plt.savefig(f'Basic-Neural-Networks/B/B_{COUNT}samples_{EPOCHS}epoch_{BATCH}batch_{TEST}test.jpg', bbox_inches='tight')
plt.show()
...
plt.legend()
plt.grid()
plt.savefig(f'Basic-Neural-Networks/B/B_{COUNT}samples_{EPOCHS}epoch_{BATCH}batch_{TEST}test LOSSES.jpg', bbox_inches='tight')
plt.show()
