...
plt.xlabel("True amount of points")
plt.ylabel("Predicted amount of points")
plt.title("True vs Predicted amount of points")
plt.legend()
plt.grid()
plt.savefig(f'Basic-Neural-Networks/D/D_{COUNT}samples_{EPOCHS}epoch_{BATCH}batch_{TEST}test.jpg', bbox_inches='tight')
plt.show()
...
plt.legend()
plt.grid()
plt.savefig(f'Basic-Neural-Networks/D/D_{COUNT}samples_{EPOCHS}epoch_{BATCH}batch_{TEST}test LOSSES.jpg', bbox_inches='tight')
plt.show()
